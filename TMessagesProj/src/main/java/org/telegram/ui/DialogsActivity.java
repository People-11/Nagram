        ...
        iBlur3Capture = new IBlur3Capture() {
            ...
            public void captureCalculateHash(IBlur3Hash builder, RectF position) {
                ...
                for (ViewPage viewPage : viewPages) {
                    ...
                    Blur3Utils.captureCalculateHashRelativeParent(viewPage.listView, builder, position, viewPage.listView, contentView, 255 - searchViewAlpha);
                }
                if (searchViewPager != null && searchViewPager.getVisibility() == View.VISIBLE && searchViewPager.getAlpha() > 0f) {
                    Blur3Utils.captureCalculateHashRelativeParent(searchViewPager, builder, position, searchViewPager, contentView, searchViewAlpha);
                }
            }
        };
...
//            }
    ...
    private void blur3_InvalidateBlur() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.S || scrollableViewNoiseSuppressor == null || fragmentView == null || actionBar == null || !SharedConfig.chatBlurEnabled()) {
            return;
        }
